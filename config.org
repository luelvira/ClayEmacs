...
(setq private-emacs-directory "~/.emacs.d-develop/"
...
:HEADER-ARGS:emacs-lisp+: :shebang ;;; init-consts.el --- setup default consts -*- lexical-binding: t -*-
:END:
...
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle "modules/init-core.el"
:HEADER-ARGS:emacs-lisp+: :shebang ;;; module/init-core.el --- setup default configuration -*- lexical-binding: t -*-
:END:
...
#+begin_src emacs-lisp :tangle no :noweb-ref core-setq
;; ResetVars
...
#+begin_src emacs-lisp :tangle no :noweb-ref core-require
(require 'savehist)
#+end_src
...
#+begin_src emacs-lisp :tangle no :noweb-ref core-setqdefault
...
** TODO Maximize windows by default and setup transparency
...
* lem module
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/init-mode.el
:END:
...
I like to have transparency in some frames such as the terminal or editors like Emacs.
...
This functions allows to change the opacity of the current frame

#+begin_src emacs-lisp :tangle no :noweb-ref group-functions
...
* Theming
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/init-theme.el
:END:
...
** Modeline
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/init-modeline.el
:END:
...
** Fonts
:PROPERTIES:
:HEADER-ARGS:emacs-lisp+: :tangle modules/init-fonts.el
:END:
